...
public static class RteExtensionMethods
{
    ...
    /// Unty moves the rect when setting RectTransform.pivot with this method now you can avoid that.
    /// Also scaled objects are supported when using this method.
    /// </summary>
